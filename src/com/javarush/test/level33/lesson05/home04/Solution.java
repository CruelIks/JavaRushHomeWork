...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String first = "\"className\":\"" + one.getClass().getSimpleName().toLowerCase() + "\"";
        String second = "\"className\":\"" + resultClassObject.getSimpleName().toLowerCase() + "\"";
        jsonString = jsonString.replaceFirst(first, second);
