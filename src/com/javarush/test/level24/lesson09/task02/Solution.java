    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                String n1 = stock1.get("name").toString();
                String n2 = stock2.get("name").toString();
                ...
                double prib1 = last1 - open1;
                double prib2 = last2 - open2;

                result = Double.compare(prib1, prib2) * (-1);
