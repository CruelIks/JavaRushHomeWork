...
public class Solution
{
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        {
            aCount = staticCount.incrementAndGet();
            /*System.out.println("AmigoThreadFactory constructor");*/
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            int bbC = bCount.incrementAndGet();
            ...
            String groupName = myThread.getThreadGroup().getName();

            String threadName = String.format("%s-pool-%d-thread-%d", groupName, aCount, bbC);
